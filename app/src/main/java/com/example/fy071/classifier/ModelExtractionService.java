...
public class ModelExtractionService extends IntentService {
    ...
    private static final String TAG = ModelExtractionService.class.getSimpleName();
    ...
    private void handleModelExtraction(final String modelName, final int modelRawResId) {
        ...
        try {
            ...
            getContentResolver().notifyChange(Uri.withAppendedPath(FileProvider.getUri(), modelName), null);
        } catch (IOException e) {
